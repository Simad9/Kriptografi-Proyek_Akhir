...
<body class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-10 p-3 bg-putih-secondary">
      ...
      <h3 class="mt-3">Enkripsi File</h3>
      ...
      <form class="card" action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
          ...
          <?php if (isset($enkripsi_file)) : ?>
            <div>
              <a href="uploads/file_enkripsi/<?= $enkripsi_file['download'] ?>" download><button type="button" class="btn btn-ijo-primary-outline w-100 mt-3">Download</button></a>
            </div>
          <?php endif ?>
        </div>
      </form>
